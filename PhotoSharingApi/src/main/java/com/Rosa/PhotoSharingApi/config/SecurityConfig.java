package com.Rosa.PhotoSharingApi.config;
...
import com.Rosa.PhotoSharingApi.service.Impl.UserDetaileServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	@Autowired
	UserDetailsService userDetaileService;
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		auth.userDetailsService(userDetaileService).passwordEncoder(bCryptPasswordEncoder);
}
